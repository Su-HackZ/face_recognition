...
public class AttendenceMlkit extends AppCompatActivity {
    ...
    Button buverify,btn_retry,btn_cancel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendence_mlkit);
        ...
        progressDialog = new ProgressDialog(AttendenceMlkit.this);
        ...
        btn_cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent send = new Intent(AttendenceMlkit.this, MainActivity.class);
                startActivity(send);
                finish();
            }
        });
                    ...
                    public void run() {
                        ...
                        if(distance<6.0) {
                            result_text.setText("Result : Same Faces");
                                ...
                                Intent send = new Intent(AttendenceMlkit.this, AttendenceActivity.class);
                                send.putExtra("name",subjectname);
                                send.putExtra("sucess","sucess");
                                startActivity(send);
                                finish();
                        }
                        else{
                            result_text.setText("Result : Different Faces");
                            Toast.makeText(AttendenceMlkit.this, "Unable to connect try Again", Toast.LENGTH_LONG).show();
                            Intent send = new Intent(AttendenceMlkit.this, MainActivity.class);
                            startActivity(send);
                            finish();
                        }
